...
request_body = {
  "query": {
    "where" : "(REGEXP_CONTAINS(CONCAT(title, ' ', IFNULL(snippet, '')), r'(?i)(\\b)(kill\\w{0,}|died\\w{0,}|injur\\w{0,}|dead\\w{0,}|death\\w{0,}|wounded|massacre\\w{0,})(\\b)') AND language_code='en' AND publication_date >= '2010-01-01 00:00:00' AND LOWER(source_code) IN ('aprs','lba','xnews','afnws','ajazen','bbcsup','bbcapp','bbcmep','bbceup','bbcap','bbcca','bbcmnf','bbcmap','bbcukb','bbcukb','bbcsap','bbccau','bbcmm'))",
      "includes": {
